...
my $optd = Lingua::NATools::PTD->new("t/_out.dmp");

isa_ok $optd => "Lingua::NATools::PTD";
isa_ok $optd => "Lingua::NATools::PTD::Dumper";
...
my $sptd = Lingua::NATools::PTD->new("t/_out.sqlite");

isa_ok $sptd => "Lingua::NATools::PTD";
isa_ok $sptd => "Lingua::NATools::PTD::SQLite";
...
my $bzptd = Lingua::NATools::PTD->new("t/_out.dmp.bz2");

isa_ok $bzptd => "Lingua::NATools::PTD";
isa_ok $bzptd => "Lingua::NATools::PTD::BzDmp";
...
my $xzptd = Lingua::NATools::PTD->new("t/_out.dmp.xz");

isa_ok $xzptd => "Lingua::NATools::PTD";
isa_ok $xzptd => "Lingua::NATools::PTD::XzDmp";
...
$ptd1->lowercase;
isa_ok $ptd1,"Lingua::NATools::PTD"; # still a PTD
